package ru.otus.annotation.usage;

import java.util.ArrayList;
import java.util.List;
import ru.otus.annotation.NonEmpty;
import ru.otus.annotation.Unfinished;
import ru.otus.annotation.inheritance.Email;
import ru.otus.annotation.inheritance.Immutable;
